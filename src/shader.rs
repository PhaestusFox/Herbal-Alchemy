...
use bevy::render::render_resource::{
    AsBindGroupShaderType, Face, RenderPipelineDescriptor, ShaderType,
...
#[uuid = "f3308b4d-cb67-4189-bbc8-1513c35663dd"]
...
impl AsBindGroupShaderType<StandardMaterialUniform> for CustomMaterial {
...
impl From<&CustomMaterial> for StandardMaterialKey {
